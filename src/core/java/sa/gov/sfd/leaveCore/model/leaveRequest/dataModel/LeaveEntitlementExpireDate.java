 ...
 * @project leaveSystem
 **/
public final class LeaveEntitlementExpireDate {

    private final  LocalDate expireDate_AH; // Hijri Date
    private final  LocalDate expireDate_AD; // Gregorian Dates

    public LeaveEntitlementExpireDate(LocalDate expireDate_AH, LocalDate expireDate_AD) {
    ...
    public boolean equals(Object o) {
        ...
        LeaveEntitlementExpireDate that = (LeaveEntitlementExpireDate) o;
