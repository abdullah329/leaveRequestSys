 ...
 * @project leaveSystem
 **/
public class LastApprovalTransactionLine {
    ...
    public LastApprovalTransactionLine(LeaveApprovalTransDate leaveApprovalTransDate, LeaveId leaveRequestId, ProcessFlowId processId, processFlowScenarioId approvalScenarioId, int processStepNumber, ApproverTeamId approverTeamId, EmployeeNID employeeNID) {
    ...
    public boolean equals(Object o) {
        ...
        LastApprovalTransactionLine that = (LastApprovalTransactionLine) o;
