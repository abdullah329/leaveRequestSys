...
export class LeaveApplicationService {
    ...
    public findAll(): Observable<LeaveApplicationModel[]> {
        return this.http.get<LeaveApplicationModel[]>(this.applicationUrl + 'applications');
    }

    public findById(id: number): Observable<LeaveApplicationModel> {
    ...
    public save(application: LeaveApplicationModel) {
        return this.http.post<LeaveApplicationModel>(this.applicationUrl + 'applications', application);
    }
